...
{   
    ...
    public void Sacar(double valor){
        if (this.Saldo + this.Limite <= valor){
            Console.WriteLine("Valor Inválido! Você está tentando sacar mais do que você tem!");
        }else{
             this.Saldo -= valor;
        }
    }
    ...
    public string emprestimo(int parcelas, double dinheiro){
        ...
        string resultado = "O valor de sua parcela sem juros é: "+ div +". E o valor da parcela com juros: "+ mult + ". O valor do juros com prestações é de: "+ soma +"e o valor total a pagar é de: "+total;
        return resultado;
